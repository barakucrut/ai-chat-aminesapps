      ...
      if (message.type == 'location') {
        ...
        if (result?.data?.covered == 1) {
          ...
          pesankirim = `⚠️ Terima kasih, lokasi yang Anda kirim saat ini belum masuk dalam jangkauan utama jaringan ODP JemberWifi.\n
            Namun, masih memungkinkan untuk dilakukan pemasangan dengan penambahan kabel dari titik ODP terdekat. Estimasi tambahan biaya sekitar Rp ${
              (Math.ceil(result?.data?.odp[0].distance_m) - 250) * 1000
